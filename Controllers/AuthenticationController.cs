...
namespace CityInfoAPI.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public ActionResult<string> Authenticate(AuthenticationRequestBody authenticationRequestBody)
        {
            ...
            var user = ValidateUserCedentials(authenticationRequestBody.UserName, authenticationRequestBody.Password);
            ...
            var jwtSecurityToken = new JwtSecurityToken(_configuration["Authentication:Issuer"],
                _configuration["Authentication:Audience"], claimsForToken, DateTime.UtcNow, 
                DateTime.UtcNow.AddHours(1), signingCredential);
        ...
        private CityInfoUser ValidateUserCedentials(string? userName, string? password)
        {
            ...
            return new CityInfoUser(1, userName ?? "", "Mario", "Casillas", "Antwerp");
        }
    }
